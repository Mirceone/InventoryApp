...
class RefreshTokenServiceTest {
    ...
    void revokeAllForUserRevokesAllActiveTokens() {
        UUID userId = UUID.randomUUID();
        RefreshTokenEntity token1 = new RefreshTokenEntity(userId, "hash1", Instant.now().plusSeconds(1000));
        RefreshTokenEntity token2 = new RefreshTokenEntity(userId, "hash2", Instant.now().plusSeconds(1000));
